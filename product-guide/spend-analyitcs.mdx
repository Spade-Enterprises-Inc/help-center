...
The dashboard provides a comprehensive view of your spend analytics, divided into the following sections:
...
- **Spend Amount**: The monetary value of a transaction, which can be filtered to show amounts greater than, less than, or equal to a specified figure.
- **Spend Method**: The method used to make the payment, such as through an invoice or a credit card.

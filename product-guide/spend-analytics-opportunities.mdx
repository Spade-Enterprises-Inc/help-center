...
- **Likely**: High likelihood of supplier spend being tied to the category, based on your spend transaction line items.
- **Possible**: Potential association between the supplier's spend and the category, inferred from both spend data and supplier information.
...
![Dashboard Filters](/images/gifs_images/opportunities-categories.png)
...
![Dashboard Filters](/images/gifs_images/opportunities-supplier.png)
